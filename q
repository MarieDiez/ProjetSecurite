...
DDEESSCCRRIIPPTTIIOONN
       ...
       pointed to by _s_t_a_t_b_u_f.  No permissions are required on the  file  it‐
       self,  but—in  the  case  of  ssttaatt(),  ffssttaattaatt(), and llssttaatt()—execute
       (search) permission is required on all of the directories in _p_a_t_h_n_a_m_e
       that lead to the file.

       ssttaatt()  and  ffssttaattaatt() retrieve information about the file pointed to
       by _p_a_t_h_n_a_m_e; the differences for ffssttaattaatt() are described below.

       llssttaatt() is identical to ssttaatt(), except that if _p_a_t_h_n_a_m_e is a symbolic
       link, then it returns information about the link itself, not the file
       that it refers to.

       ffssttaatt() is identical to ssttaatt(), except that the file about which  in‐
       formation is to be retrieved is specified by the file descriptor _f_d.
   ...
   TThhee ssttaatt ssttrruuccttuurree
       ...
       _N_o_t_e: the order of fields  in  the  _s_t_a_t  structure  varies  somewhat
       ...
       _s_t___d_e_v This  field  describes  the device on which this file resides.
              (The mmaajjoorr(3) and mmiinnoorr(3) macros may be useful  to  decompose
       ...
       _s_t___b_l_o_c_k_s
              ...
              _s_t___s_i_z_e/512 when the file has holes.)
   ...
   ffssttaattaatt(())
       ...
       AATT__EEMMPPTTYY__PPAATTHH (since Linux 2.6.39)
              If  _p_a_t_h_n_a_m_e  is an empty string, operate on the file referred
              to by _d_i_r_f_d (which may have been obtained  using  the  ooppeenn(2)
              OO__PPAATTHH  flag).   In  this case, _d_i_r_f_d can refer to any type of
              file, not just a directory, and the behavior of  ffssttaattaatt()  is
              similar  to  that  of ffssttaatt().  If _d_i_r_f_d is AATT__FFDDCCWWDD, the call
              operates on the  current  working  directory.   This  flag  is
              Linux-specific; define __GGNNUU__SSOOUURRCCEE to obtain its definition.

       AATT__NNOO__AAUUTTOOMMOOUUNNTT (since Linux 2.6.38)
              Don't  automount  the terminal ("basename") component of _p_a_t_h_‐
              _n_a_m_e if it is a directory that is an  automount  point.   This
              allows  the  caller to gather attributes of an automount point
              (rather than the location it would mount).  Since Linux  4.14,
              also  don't instantiate a nonexistent name in an on-demand di‐
              rectory such as used for automounter indirect maps.  This flag
              can be used in tools that scan directories to prevent mass-au‐
              tomounting of a directory of automount points.  The  AATT__NNOO__AAUU‐‐
              TTOOMMOOUUNNTT flag has no effect if the mount point has already been
              mounted over.  This flag is Linux-specific; define __GGNNUU__SSOOUURRCCEE
              to  obtain  its  definition.   Both  ssttaatt() and llssttaatt() act as
              though AATT__NNOO__AAUUTTOOMMOOUUNNTT was set.
...
EERRRROORRSS
       ...
       EENNOOEENNTT A component of _p_a_t_h_n_a_m_e does not exist or is a  dangling  sym‐
              bolic link.

       EENNOOEENNTT _p_a_t_h_n_a_m_e  is  an empty string and AATT__EEMMPPTTYY__PPAATTHH was not speci‐
       ...
       EEOOVVEERRFFLLOOWW
              ...
              types _o_f_f___t, _i_n_o___t, or _b_l_k_c_n_t___t.  This error can  occur  when,
              for  example,  an  application  compiled  on a 32-bit platform
              without _-_D___F_I_L_E___O_F_F_S_E_T___B_I_T_S_=_6_4 calls ssttaatt() on  a  file  whose
              size exceeds _(_1_<_<_3_1_)_-_1 bytes.
       ...
       EENNOOTTDDIIRR
              _p_a_t_h_n_a_m_e  is relative and _d_i_r_f_d is a file descriptor referring
...
CCOONNFFOORRMMIINNGG TTOO
       ...
       According  to  POSIX.1-2001,  llssttaatt()  on a symbolic link need return
       valid information only in the _s_t___s_i_z_e field and the file type of  the
       _s_t___m_o_d_e field of the _s_t_a_t structure.  POSIX.1-2008 tightens the spec‐
       ification, requiring llssttaatt()  to  return  valid  information  in  all
       fields except the mode bits in _s_t___m_o_d_e.

       Use  of  the  _s_t___b_l_o_c_k_s  and  _s_t___b_l_k_s_i_z_e fields may be less portable.
...
NNOOTTEESS
   TTiimmeessttaammpp ffiieellddss
       ...
       stamp  fields.   Instead, there were three timestamp fields—_s_t___a_t_i_m_e,
       _s_t___m_t_i_m_e, and _s_t___c_t_i_m_e—typed as _t_i_m_e___t that recorded timestamps  with
       one-second precision.

       Since  kernel  2.5.48, the _s_t_a_t structure supports nanosecond resolu‐
       tion for the three file timestamp fields.  The nanosecond  components
       of   each   timestamp   are   available   via   names   of  the  form
       _s_t___a_t_i_m_._t_v___n_s_e_c,  if  suitable  feature  test  macros  are   defined.
       Nanosecond  timestamps were standardized in POSIX.1-2008, and, start‐
       ing with version 2.12, glibc exposes the nanosecond  component  names
       if  __PPOOSSIIXX__CC__SSOOUURRCCEE  is defined with the value 200809L or greater, or
       __XXOOPPEENN__SSOOUURRCCEE is defined with the value 700 or greater.   Up  to  and
       including  glibc  2.19, the definitions of the nanoseconds components
       are also defined if __BBSSDD__SSOOUURRCCEE or __SSVVIIDD__SSOOUURRCCEE is defined.  If  none
       of  the aforementioned macros are defined, then the nanosecond values
       are exposed with names of the form _s_t___a_t_i_m_e_n_s_e_c.
   ...
   CC lliibbrraarryy//kkeerrnneell ddiiffffeerreenncceess
       ...
       _s_y_s___n_e_w_s_t_a_t() (slot _____N_R___s_t_a_t), and _s_y_s___s_t_a_t_6_4_(_)  (slot  _____N_R___s_t_a_t_6_4)
       on  32-bit  platforms  such as i386.  The first two versions were al‐
       ready present in Linux 1.0 (albeit with different  names);  the  last
       was  added  in  Linux  2.4.   Similar  remarks  apply for ffssttaatt() and
       llssttaatt().
       ...
       _s_t_a_t_6_4 Even  larger  _s_t___i_n_o field, larger _s_t___u_i_d and _s_t___g_i_d fields to
              ...
              the structure.  (Various padding bytes  were  eventually  con‐
              sumed  in  Linux 2.6, with the advent of 32-bit device IDs and
       ...
       by the kernel, and repacking the returned information if required for
       old binaries.
...
EEXXAAMMPPLLEE
       The  following  program calls llssttaatt() and displays selected fields in
       the returned _s_t_a_t structure.
...
SSEEEE AALLSSOO
       llss(1), ssttaatt(1), aacccceessss(2), cchhmmoodd(2), cchhoowwnn(2), rreeaaddlliinnkk(2), ssttaattxx(2),
       uuttiimmee(2), ccaappaabbiilliittiieess(7), iinnooddee(7), ssyymmlliinnkk(7)
